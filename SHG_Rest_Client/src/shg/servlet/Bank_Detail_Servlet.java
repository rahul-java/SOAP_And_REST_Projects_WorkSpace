...
import shg.bean.Bank_Bean;
import shg.bean.DistrictBean;
import shg.master.Bank_DAO;
import shg.master.StateDAO;
	    ...
	    Bank_Bean bank_Bean=Bank_DAO.getBankDetails(ifsc);	
		 if (Bank_DAO.check_IFSC(ifsc))
		 {
			 ...
			 out.println("<html><body><table>");
			   out.println("<tr><th>Bank Name :</th><td><input type='text' name='bank_name' value='"+bank_Bean.getBank_name()+"' readonly></td>");
			   out.println("<tr><th>Branch Name :</th><td><input type='text' name='branch_name' value='"+bank_Bean.getBranch_name()+"' readonly></td>");
