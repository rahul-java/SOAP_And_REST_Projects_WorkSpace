...
import shg.bean.MemberBean;
import shg.bean.SHGBean;
...
public class ShgDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MemberBean memberNBean=new MemberBean();
		...
		memberBean_List.add(memberNBean);
		
		String xml=MarshlingClass.getData(sHGList,memberBean_List);
