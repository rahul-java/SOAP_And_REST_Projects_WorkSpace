<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <jsp:useBean id="ob" class="max.dao.StateDAO">
    </jsp:useBean>
...
<tr >    
<th>Group Name :</th><td><input type="text" name="gname" required="required"></td></tr>
<tr><th>Account No :</th><td><input type="text" name="an" required="required"></td>
<th>IFSC :</th><td><input type="text" name="ifsc"  id="ifsc"  required="required"    onblur="getBankDetail(this.value);"></td></tr>
<tr id="bankDetail"></tr>
<tr><th>State Name :</th>


<td><select name="stCode"  required="required"    onchange="getAllDistrict(this.value)">
...
<th>District Name :</th>
                      <td>
                      <select name="districtCode"  required="required" id="select_District">
...
<table id="member" bgcolor="yellow" border ="3">
  ...
  <tr>
     <td>1</td><td><input type="checkbox"  required="required"   name="chk"></td>
     <td><input type="text" required="required" name="mname"></td>
     <td><input type="text" required="required" name="mage"></td>
     <td><input type="text" required="required" name="madhar" pattern="^\d{4}\s\d{4}\s\d{4}$"></td>
  </tr>
  
</table>
<table>
<tr><td><input type="submit" value="Save"></td>
<td><a href=display.jsp>View</a></td>
</tr>
</table>
